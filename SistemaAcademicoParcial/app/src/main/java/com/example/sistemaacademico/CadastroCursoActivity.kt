...
class CadastroCursoActivity : AppCompatActivity() {
    ...
    internal var dbHelperCurso = CursoDao(this)
    /**
     * Criando uma função para que seja apresentada uma notificação
     */
    fun showToast(text: String) {
        Toast.makeText(this@CadastroCursoActivity, text, Toast.LENGTH_LONG).show()
    }
    ...
    fun controlerUpdate() {
        bnAtualizar.setOnClickListener {
            try {
                val isUpdate = dbHelperCurso.alterarDados(
                    txtID.text.toString(),
                    txtNome.text.toString(),
                    txtEixoTecnologico.text.toString(),
                    txtDuracao.text.toString(),
    ...
    fun controlerDelete() {
        bnExcluir.setOnClickListener {
            try {
                dbHelperCurso.deletarDados(txtID.text.toString())
                limpaCampo()
