...
class DatabaseHelper(context: Context) :
     ...
     */
    fun inserirDados(nome: String, curso: String, campus: String, turno: String) {
        val db = this.writableDatabase
        val contentValues = ContentValues()
        contentValues.put(COL_2, nome)
        contentValues.put(COL_3, curso)
        contentValues.put(COL_4, campus)
        contentValues.put(COL_5, turno)
     ...
     */
    fun alterarDados(id:String, nome: String, curso: String, campus: String, turno: String):Boolean {
        val db = this.writableDatabase
        val contentValues = ContentValues()
     ...
     */
    companion object {
        val DATABASE_NAME = "CrudTurmasBD.db"
